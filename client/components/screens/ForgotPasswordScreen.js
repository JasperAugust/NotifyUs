...
export default class ForgetPasswordScreen extends React.Component {
  ...
  async forgotPassword() {
    ...
    await Auth.forgotPassword(username)
      ...
      .catch(err => {
        if (!err.message) {
          console.log('setting up the new password failed: ', err);
          Alert.alert('setting up the new password failed: ', err);
        } else {
          console.log('setting up the new password failed: ', err.message);
          Alert.alert('setting up the new password failed: ', err.message);
        }
      });
  }
